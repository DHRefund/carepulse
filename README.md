...
@layer utilities {
  ...
  .shad-input {
    @apply bg-dark-400 text-dark-700 placeholder:text-dark-600 border-dark-500 h-11 focus-visible:ring-0 focus-visible:ring-offset-0 !important;
  }
  ...
  .shad-textArea {
    @apply bg-dark-400 text-dark-700 placeholder:text-dark-600 border-dark-500 focus-visible:ring-0 focus-visible:ring-offset-0 !important;
  }
